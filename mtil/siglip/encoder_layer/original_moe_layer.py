            ...
            if self.apply_moe == True:
                if self.task_id > -1:
                    ...
                    if val_task_id is not None and self.autorouter == True:  # val情况
                        ...
                        #     print('layer_val_task_id:', val_task_id)
                    ...
                    expert_outputs = [self.adaptmlp_list[i](expert_inputs[i]
                                                            .view(expert_inputs[i].shape[0], x.shape[0], x.shape[2]).to(x), add_residual=False)
                    ...
                    x = x + self.mlp(self.layer_norm2(x)) + y.permute(1, 0, 2)
                else:  # 单expert情况
                    x_re = x.permute(1, 0, 2)[:, 0, :]
                ...
                x = x + self.mlp(self.layer_norm2(x)) + adapt_x
